...
import type { EditorDraft } from '../../../lib/editor-state/types'
import type { LayerData } from '../../../lib/keymap-dt/types'
import {
  copyKeymapToClipboard,
  downloadKeymapPng,
  type ExportArgs,
} from '../../../lib/keymap-image/export'
import type { BgKind, LayoutKind } from '../../../lib/keymap-image/canvas'
...
export function ExportPanel({ layers, draft, onClose }: ExportPanelProps) {
  ...
  const onDownload = async () => {
    ...
    setBusy(true)
    try {
      await downloadKeymapPng(currentArgs(), 'dax3-layers.png')
