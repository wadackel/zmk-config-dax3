...
- **`AGENTS.md`**: 現在の確定仕様・挙動・手順（"what/how"）
- **`docs/encoder-tuning-learnings.md`** 等: 試行錯誤の過程・学びの記録

ADRは決定の凍結ポイントを残し、AGENTS.md はその決定を反映した最新仕様を保持する。役割分担は [ADR-0001](./0001-adopt-adrs.md) を参照。

## 起票ルール

起票が必要な条件、更新運用は `AGENTS.md` の「ADR運用ルール」節を参照。
